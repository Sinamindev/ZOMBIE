...
int main(int argc, char** argv)
{
	...
	/* Allocate a segment with key 1235, of size 1024 bytes, and the region is
 	 ...
 	 * does not exist, IPC_EXCL, IPC_EXCL = fail if the segment already exists,
	 * the user has the persmission to read this memory segment, S_IWUSR the = the
	 * user has the permission to write this memory segment).
 	 */
